package hu.kasler.jeeconfigexample.view;
...
import hu.kasler.jeeconfigexample.model.Person;
...
public class PersonBean implements Serializable {
	...
	@PersistenceContext(unitName = "jeeconfigexample-persistence-unit", type = PersistenceContextType.EXTENDED)
	...
	public String update() {
		...
		try {
			if (this.id == null) {
				...
				System.out.println("Person saved, deltaspike welcome config value is: " + jeeconfigexampleMessage);
